...
export class ExamController {
  ...
  attachQuestions = asyncHandler(async (req: Request, res: Response) => {
    ...
    await this.examService.attachQuestions(examId, questionIds);
  ...
  removeQuestion = asyncHandler(async (req, res) => {
    ...
    await this.examService.removeQuestion(examId, questionId);
  ...
  preview = asyncHandler(async (req, res) => {
    ...
    const exam = await this.examService.getPreview(examId);
